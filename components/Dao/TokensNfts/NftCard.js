...
export default function NftCard({ nft }) {
  ...
  const nftCardImg = React.useMemo(() => {
    return nftImageSrc ? (
      ...
      <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-xl bg-white object-contain font-bold shadow-lg lg:h-40 dark:bg-black lg:w-40">
        NFT
      </div>
    )
  }, [nftImageSrc])
