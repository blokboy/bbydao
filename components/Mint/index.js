...
import MintErrorModal from "./MintErrorModal"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex flex-col items-center justify-center p-10">
        ...
        <div className="text-l mt-3">
          To mint one of {theme && theme === "dark" ? 5000 : 500} available bbyDAO{" "}
          {theme && theme === "dark" ? "White" : "Black"} Cards, switch to
      ...
      <div className="flex flex-col items-start justify-center p-10">
        ...
        <p className="text-l mt-3">20% of platform fees are claimable by holders on an interval</p>
        <p className="text-l mt-3">Holders will receive generative bbyDAO PFPs</p>
        <a
          className="text-l mt-3 cursor-pointer"
          target="_blank"
          href="https://mirror.xyz/0x98B691df2794142AcdE5E732a00f785DAB55Dbae/K6LmUXixMkZ1X6HzrKxHn84le7KV3LUeoZmrdGZwuZ4"
        >
          Read More
        </a>
      </div>
      ...
      <div className="flex flex-col items-start justify-center p-10">
        ...
        <p className="mt-3 mb-3 text-xl">
          You are minting 1 bbyDAO {theme && theme === "dark" ? "Black" : "White"} Card for{" "}
